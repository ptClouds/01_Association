...
#sidebar a:link,
	...
	<BODY class=homepage>
		...
		<s:iterator value="%{#request.assoHadDealList}" id="s">
			<div><span id="t">
			<table width=880px align=center>
				<tr align=center>
					<td width=120px>
					...
					<s:if test="%{flag == 0}">
					<td width=120px>
						<a href="adminUserrevokeAssoInfo.action?assoVo.assoId=<s:property value='#s.assoId' />
								...
								&assoVo.remarks=<s:property value='#s.remarks' />
								&assoVo.approve=<s:property value='#s.approve' />"><font size=2 color=red>撤销</font></a>
					</td>
					</s:if>
				</tr>
			</table>
