...
#sidebar a:link,
	...
	<BODY class=homepage>
		...
		<s:iterator value="%{#request.assoStatusList}" id="s">
			<div><span id="t">
			<table width=860px align=center>
				<tr align=center>
					<td width=120px>
					...
					<td width=120px>
						<font size=2><a href="adminUserdealJoinAssoInfo.action?contactVo.contactId=<s:property value='#s.contactId' />
								...
								&contactVo.assoDuty=<s:property value='#s.assoDuty' />">审批</a></font>
					</td>
				</tr>
			</table>
			</span>
