function demoControl() {
	...
	var colsToHide = widget.ariaSorTable("option", "colsToHide");		
		...
		html +=		'		<legend class="ui-widget-header ui-corner-all">精确查询</legend>';
		html +=		'		<form id="search">';
		html +=		'			<input type="text" id="search-field" class="text ui-widget-content ui-corner-all" />';
		html +=		'			<input type="submit" id="submit" value="查询" class="submit ui-state-default ui-corner-all" />';
		html +=		'		</form>';
		html +=		'	</fieldset>';
		html +=		'	<fieldset class="ui-widget-content ui-corner-all">';
		html +=		'		<legend class="ui-widget-header ui-corner-all">指定显示列</legend>';
	...
	for (var x = 0; x < headers.length; x++){
		...
		html +=		'			<input type="submit" value="显示" class="submit ui-state-default ui-corner-all" />';
		html +=		'		</form>';
		html +=		'	</fieldset>';
		html +=		'</div>';
	$("#wrapper").append(html);
